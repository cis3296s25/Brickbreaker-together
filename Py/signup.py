...
class SignUpScreen:
    def __init__(self, screen):
        ...
        self.signup_button_rect = pygame.Rect(self.screen_width//2 - 80, 400, 160, 50)
        self.goto_login_rect = pygame.Rect(self.screen_width//2 - 80, 470, 160, 40)
        ...
        self.focus_list = ["username", "password", "signup_button"]
